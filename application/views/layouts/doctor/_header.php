        ...
        <div class="row align-items-center">
            <div class="col-md-3">
                <div class="logo">
                    ...
                    <!-- <?= $this->session->userdata('id_store'); ?> -->
                </div>
            </div>
                ...
                <div class="clearfix d-md-inline-block d-block">
                    <div class="user-profile m-0">
                        ...
                        <div class="dropdown-menu">
                            <?php $id_doctor = $this->session->userdata('id_doctor'); ?>
                            <a class="dropdown-item my-profile-doctor" data-id-doctor="<?= isset($id_doctor) || $id_doctor != "" ? $id_doctor : "" ?>" href="#">My Profile</a>
                            <a class="dropdown-item change-pass-doctor" href="#">Change Password</a>
