    ...
    <table class="table">
        ...
        <tfoot>
            <tr>
                ...
                <td></td>
                <td></td>
                <td><h4><b>Rp&nbsp;<?= number_format(array_sum(array_column($content, 'subtotal')), 0, ',', '.') ?>,-</b></h4></td>
            </tr>
            <tr>
                <td></td>
                <td><h4><b>Discount Total :</b></h4></td>
                <td></td>
                <td></td>
                <td><h4><b>-&nbsp;Rp&nbsp;<?= number_format($get_total_discount, 0, ',', '.'); ?>,-</b></h4></td>
            </tr>
            ...
            <tr>
                ...
                ?>
                <td><h4><b>Rp&nbsp;<?= number_format($total, 0, ',', '.') ?>,-</b></h4></td>
            </tr>
        </tfoot>
