...
<div class="modal-body">
    ...
    <div class="text-center mb-4">
        <img src="<?= base_url(); ?>assets/images/author/avatar_doctor.jfif" class="" style="border-radius: 50%;" width="120" alt="avatar_doctor">
    </div>
    <button type="button" class="btn btn-xs btn-hers-primary" id="editProfileDoctor"><i class="ti-pencil mr-2"></i>Edit Profile</button>

    <div class="data-profile-doctor">
