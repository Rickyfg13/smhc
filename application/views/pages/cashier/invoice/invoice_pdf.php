...
<body>
    ...
    <div class="container-fluid" style="padding-left: 15px; padding-right: 15px;">
        ...
        <div class="row">
            <div class="col-6">
                <img src="assets/images/logo/herslogo-min.jpg" alt="logo-hers" style="width: 230px;">
            </div>
        ...
        <div class="row">
            <div class="col-12 text-right">
                <h3 class="text-heading">Invoice</h3>
            </div>
        </div>
                    ...
                    <table class="table mt-4">
                        ...
                        <tfoot class="table-borderless mt-5" style="border-top: 1px solid #dee2e6;">
                            ...
                            <tr>
                                <td></td>
                                <td></td>
                                <td><span style="font-size: 22px;">Total :</span></td>
                                <td><span style="font-size: 22px;"><strong><?= number_format($invoice_detail->total, 0, ',', '.'); ?></strong></span></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
